...
scroll.current.scrollIntoView({behavior:"smooth"})
  ...
  return (
    <div ref={scroll} className='w-fit max-w-[60%] bg-linear-to-br from-[#9500ff] to-[#ff0095] rounded-t-2xl rounded-bl-2xl rounded-br-0 px-2.5 py-2.5 relative ml-auto right-0 flex flex-col gap-2.5'>
