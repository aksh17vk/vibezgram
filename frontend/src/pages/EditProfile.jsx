...
function EditProfile() {
    ...
    return (
        <div className='w-full min-h-screen bg-black flex items-center flex-col gap-5 '>
            ...
            <input type="text" className='w-[90%] max-w-150 h-15 bg-[#0a1010] border-2 border-gray-700 rounded-2xl text-white font-semibold px-5 outline-none ' placeholder='Profession' onChange={(e)=>setProfession(e.target.value)} value={profession}/>
